...
/* ------------------------------------------------------------------ */
/* Section 03 - the Home Interior Bandung approach                                   */
/* ------------------------------------------------------------------ */
...
export const processSteps: ProcessStep[] = [
  ...
  },
  {
    index: "05",
    title: "Produksi",
    body: "Fabrikasi di workshop Home Interior Bandung dengan mesin potong presisi dan pelapisan rapi oleh pengrajin berpengalaman.",
  },
  {
    index: "06",
...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Ya, seluruh pengerjaan Home Interior Bandung bersifat custom made-to-measure. Termasuk mengatasi dinding miring, kolom struktur yang menonjol, ruang bawah tangga yang menyudut, atau langit-langit atap miring (attic).",
  },
  {
    id: "material-dapur",
