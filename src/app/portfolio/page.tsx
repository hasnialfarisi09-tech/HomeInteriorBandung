...
const PORTFOLIO_DESCRIPTION = `Dokumentasi ${projectCount} proyek furniture custom Home Interior Bandung: kitchen set, lemari pakaian, sampai interior rumah penuh di apartemen, perumahan, dan rumah subsidi.`;
  ...
  return jsonLdGraph(
    {
      ...webPageJsonLd({
        path: "/portfolio",
        name: "Portofolio Proyek Home Interior Bandung",
        description: PORTFOLIO_DESCRIPTION,
        type: "CollectionPage",
        breadcrumb: true,
