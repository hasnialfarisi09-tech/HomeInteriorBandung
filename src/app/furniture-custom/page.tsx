...
export const metadata = buildMetadata({
  title: "Furniture Custom Bandung & Jabodetabek - Workshop Presisi Home Interior Bandung",
  description:
...
function furnitureCustomJsonLd() {
  return jsonLdGraph(
    webPageJsonLd({
      path: "/furniture-custom",
      name: "Furniture Custom Home Interior Bandung",
      description:
      ...
      >
        <div className="container-site">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <Eyebrow>Standar Mutu Home Interior Bandung</Eyebrow>
            <h2
            ...
            <p className="mt-3 text-xs sm:text-sm text-on-surface-variant leading-relaxed">
              ...
              terkena air, furniture custom Home Interior Bandung dirancang tahan hingga belasan tahun.
            </p>
          </div>
