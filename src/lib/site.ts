...
export const site = {
  ...
  tagline: "Studio & Kontraktor Interior Custom Bandung",
  description:
    "Interior dan furniture custom Bandung yang dirancang presisi berdasarkan ukuran ruang, fungsi, dan karakter penggunanya. Dari konsultasi 3D, survey gratis, produksi di workshop sendiri, hingga instalasi rapi.",
  /** Trimmed for SERP snippets, which cut off around 155-160 characters. */
  metaDescription:
    "Jasa interior dan furniture custom Bandung. Spesialis kitchen set, lemari pakaian, backdrop TV, dan interior rumah presisi dengan workshop sendiri.",
  url: rawSiteUrl.replace(/\/+$/, ""),
  locale: "id-ID",

  /** Digits only, international format. Used to build wa.me links. */
  whatsappNumber: process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "6281224472204",
