 ...
 *
 * The old suffix ("Lihat N proyek yang sudah dikerjakan Home Interior Bandung")
...
function categoryDescription(category: ProjectCategory, count: number): string {
  return `${category.description} ${count} proyek nyata dari arsip Home Interior Bandung.`;
}
