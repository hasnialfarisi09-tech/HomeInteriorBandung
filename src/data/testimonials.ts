...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    id: "sample-3",
    quote:
      "Tim Home Interior Bandung memberi solusi yang masuk akal untuk ruang bawah tangga kami. Setiap sudut dimanfaatkan tanpa terlihat penuh, bukaan pintunya halus, dan hasilnya menyatu dengan interior rumah.",
